...
打开应用默认进入“数据概览”，导航位于“交易计划”上方。点击近期记录的“查看”可进入对应计划，或切换到“交易计划”继续新建和查找；计划列表仍默认显示今天创建的计划。
...
数据概览统计本机全部已保存记录，不受交易计划列表的日期或状态筛选影响。进入页面时读取最新数据，也可点击“刷新数据”手动更新；页面显示本次读取时间，刷新失败时会明确保留上次结果。
