...
<style scoped>
.order-compare-content{display:grid;gap:14px}.compare-picker{display:flex;align-items:center}.compare-picker .el-button{margin:0}.compare-warnings{display:grid;gap:10px}.compare-warnings .order-warning{margin:0}
