    ...
    <ElCollapse v-model="sections">
      <ElCollapseItem title="数据概览" name="overview">
        <div class="page-stack">
          <ElText>工作空间依次为数据概览、交易计划和行情吐槽，默认打开数据概览。看板汇总本机全部已保存计划、关联订单、已平仓订单、计划事件和复盘，不受计划列表筛选影响；进入页面会读取最新数据，也可手动刷新。</ElText>
      ...
      <ElCollapseItem title="行情吐槽" name="rants">
        <div class="page-stack">
          ...
          <ElText>点击“添加图片”或 Ctrl + V 粘贴，待发布图片可预览、移除。发布后文字与原图一同保存在本机，点击图片可放大查看。时间线每页显示 10 条，按帖子发布时间最新在前；发布新帖子后回到第一页。</ElText>
          <ElText>每条帖子下可发布纯文字、纯图片或图文回复。文字最多 500 字且去除首尾空白；图片最多 4 张 PNG、JPEG 或 WebP，每张不超过 5 MB。回复框可选图或粘贴，发布前可预览、移除图片，发布后可点击放大。至少填写文字或添加图片；回复按发表时间从早到晚展示，不支持多层回复、点赞、编辑或删除。</ElText>
          <ElText>切换工作空间板块会一起提示未发布的帖子和回复草稿，刷新或关闭页面由浏览器提示；发布期间暂时不能切换，失败后保留输入。翻页和刷新时间线会保留各帖的回复文字与图片草稿。</ElText>
