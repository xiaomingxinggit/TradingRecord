    ...
    <ElCollapse v-model="sections">
      <ElCollapseItem title="计划与订单分别记录" name="plans">
        <div class="page-stack">
          <ElText>交易计划记录分析、截图、价位和出场理由。状态包括草稿、待触发、未触发、取消、失效；待触发需填写品种、方向、周期与理由。原计划价格完整时显示价格距离的收益 / 风险倍数，未计成本。</ElText>
      ...
      <ElCollapseItem title="订单录入与截图核对" name="orders">
        <div class="page-stack">
          ...
          <ElText>持仓中模式分别读取订单号和开仓时间。支持品种、订单号、开仓时间、类型、交易量、开仓价、止损、止盈、当前价、浮动盈利这一列序；不需要表头，但需保留整行宽度和列宽比例。右侧当前价与浮盈不录入，识别不可靠的字段留空后手动补填。</ElText>
