  ...
  <ElDialog v-model="visible" title="使用说明" width="min(680px, calc(100vw - 32px))" align-center>
    <ElCollapse v-model="sections">
      ...
      <ElCollapseItem title="更改计划状态" name="status">
        <div class="page-stack">
          <ElText>直接点击列表或详情中的状态标签，在弹层选择其他状态标签即可更改：草稿（想法未整理完）、待执行（等待入场条件）、已执行（已实际开仓，不代表已平仓）和已放弃（决定不执行）。可改回其他状态纠正误操作，当前状态不在选项中。</ElText>
          <ElText>用 Tab 聚焦标签、Enter / Space 打开，方向键移动、Enter / Space 选择；点击外部或按 Esc 关闭。</ElText>
