    ...
    <ElCollapse v-model="sections">
      ...
      <ElCollapseItem title="行情吐槽" name="rants">
        <div class="page-stack">
          ...
          <ElText>每条帖子下可发布最多 500 字的纯文字回复，首尾空白会去除，不能发布空回复。回复按发表时间从早到晚完整展示；不支持多层回复、图片回复、点赞、编辑或删除。</ElText>
          <ElText>切换工作空间板块会一起提示未发布的帖子和回复草稿，刷新或关闭页面由浏览器提示；发布期间暂时不能切换，失败后保留输入。翻页和刷新时间线不会清空草稿。</ElText>
