...
import type { Page } from '../composables/useWorkspace'
...
<template>
  <div class="navigation-frame">
    <div class="brand-area"><ElLink :underline="'never'" class="brand" @click="emit('navigate','overview')"><ElIcon class="brand-mark" :size="24"><ChartNoAxesColumnIncreasing/></ElIcon><span>TradeLog</span></ElLink><ElText type="info" size="small">个人交易工作台</ElText></div>
    <ElScrollbar class="navigation-scroll">
      <div class="navigation-content"><ElText tag="p" type="info" size="small" class="nav-label">工作空间</ElText>
        ...
        <ElMenu :default-active="page" class="workspace-menu" @select="select"><ElMenuItem index="imports"><ElIcon><Database/></ElIcon><span>导入与数据</span></ElMenuItem><ElMenuItem index="export"><ElIcon><ArrowDownToLine/></ElIcon><span>导出全部记录</span></ElMenuItem></ElMenu>
